...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <div className='navbar'>
      <Link to='/' className='logo'>Air Baking.</Link>
      ...
      <div className="navbar-right">
        ...
        {!token ? <button onClick={() => setShowLogin(true)}>ЛОГІН</button>
          : <div className='navbar-profile'>
            <img src={assets.profile_icon} alt="" />
            <ul className='navbar-profile-dropdown'>
              <li onClick={()=>navigate('/myorders')}> <img src={assets.bag_icon} alt="" /> <p>Замовлення</p></li>
              <hr />
